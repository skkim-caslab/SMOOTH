...
vector_unit_dict = {
    "A100_fp16": VectorUnit(64, 2, 35, 32, 4),
    ...
    "MI210_fp32": VectorUnit(64, 4, 18, 16, 4, data_type_dict["fp32"]),
    "TPUv3_new": VectorUnit(64 * 4, 4, 15, 128, 4, data_type_dict["fp32"]),
}
...
#    "NPU": Overhead(11e-2, 30e-2, 14e-2, 10e-2, 11e-2),
...
compute_module_dict = {
    ...
    "NPU_int8": ComputeModule(
        core_dict["Core_NPU_int8"],
        1,
        940e6, ## core freq
        12 * 1024**3, ##LPDDR5
        8, ##MemBW
...
memory_module_dict = {'A100_80GB': MemoryModule(80e9),'NPU': MemoryModule(float('inf')),'MI210': MemoryModule(64e9)}
