...
if __name__ == "__main__":
    bs = 1
    INITFLAG = False
#    model_dim = 4096  #1.3B 2048, 6.7B 4096
#    head_num = 32


#    if len(sys.argv) > 3 and sys.argv[3] == "--init":
#        INITFLAG = True
#    if model_dim == 4096: head_num = 32
#    elif model_dim == 2048: head_num = 16
#    elif model_dim == 1024: head_num = 16
    ...
    sr_data_type = "int8"
    if len(sys.argv) < 3:
        print("Usage: python simulate.py <seq_len> <tile config_file>")
        sys.exit(1)
