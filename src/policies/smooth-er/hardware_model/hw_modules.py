...
compute_module_dict = {
    ...
    "NPU_int8_2MB_1024": ComputeModule(
        core_dict["Core_NPU_int8_2MB_1024"],
        1,
        940e6,
        12 * 1024**3,  # LPDDR5
        32,            # MemBW (GB/s)
    ...
    "NPU_int8_8MB_512": ComputeModule(
        core_dict["Core_NPU_int8_8MB_512"],
        1,
        940e6,
        12 * 1024**3,
        32,
    ...
    "NPU_int8_8MB_256": ComputeModule(
        core_dict["Core_NPU_int8_8MB_256"],
        1,
        940e6,
        12 * 1024**3,
        32,
