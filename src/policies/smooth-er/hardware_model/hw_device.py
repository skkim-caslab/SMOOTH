...
device_dict = {
    ...
    "NPU_int8_2MB_1024": Device(
        compute_module_dict["NPU_int8_2MB_1024"],
        IO_module_dict["NPU"],
        memory_module_dict["NPU"],
    ),
    ...
    "NPU_int8_8MB_256": Device(
        compute_module_dict["NPU_int8_8MB_256"],
        IO_module_dict["NPU"],
        memory_module_dict["NPU"],
    ),
    "NPU_int8_8MB_512": Device(
        compute_module_dict["NPU_int8_8MB_512"],
        IO_module_dict["NPU"],
        memory_module_dict["NPU"],
    ),
