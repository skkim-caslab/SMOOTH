...
#        print("Check:", h1.shape) # [16,1,8192]
    ...
    def compile_and_simulate(self, system: System):
        ...
        if self.use_flash_attention:
            ...
            print(f"NON-linear cycles, {non_linear_latency}")
            print(f"Latency,   {self.latency/device.compute_module.clock_freq*24}")
#            print("Latency,   {mha_layernorm_latency},{q_proj_latency}, {k_proj_latency},{v_proj_latency}, {q_mul_k_latency}, {softmax_latency},{a_mul_v_latency}, {h_matmul0_latency}, {mha_allreduce_latency},{ffn_layernorm_latency},{h1_matmul1_latency}, {gelu_latency}, {h2_matmul2_latency}, {ffn_allreduce_latency}")
#            print(f"Latency,   {mha_layernorm_latency},{q_proj_latency}, {k_proj_latency},{v_proj_latency}, {q_mul_k_latency}, {softmax_latency},{a_mul_v_latency}, {h_matmul0_latency}, {mha_allreduce_latency},{ffn_layernorm_latency},{h1_matmul1_latency}, {gelu_latency}, {h2_matmul2_latency}, {ffn_allreduce_latency}")
        return self.latency
